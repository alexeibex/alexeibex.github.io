...
# Updated for Gemini 2.5 Flash (v1beta)
TERMINAL_JS = """
document.addEventListener('DOMContentLoaded', function() {
    ...
    const SYSTEM_PROMPT = `You are Legal_OS v6.3, a cyberpunk portfolio assistant for Alexei Furs. 
    ...
    // --- 3. BOOT SEQUENCE ---
    const bootSequence = [
        { text: "> INITIALIZING LEGAL_OS v6.3 (GEMINI 2.5 FLASH)...", delay: 200, class: "system-msg" },
        { text: "> CONNECTING TO NEXT-GEN NEURAL NET...", delay: 400, class: "system-msg" },
    ...
    async function callGemini(prompt) {
        ...
        // UPDATED URL: v1beta + gemini-2.5-flash
        ...
        try {
            ...
            if (data.candidates && data.candidates.length > 0) {
                 ...
                 return "> API ERROR: No response content generated.";
            }
...
STYLE_SCSS = """---
---
/* TERMINAL AESTHETIC PROTOCOL v6.3 */
...
def main():
    print("--- INSTALLING LEGAL_OS v6.3 (GEMINI 2.5 FLASH) ---")
    ...
    with open('assets/js/terminal.js', 'w') as f:
        f.write(TERMINAL_JS)
    print(" > Neural Engine (Gemini 2.5 Flash) Updated.")

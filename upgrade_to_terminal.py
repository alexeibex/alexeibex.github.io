...
STYLE_SCSS = """---
---
/* TERMINAL AESTHETIC PROTOCOL v4.0 */
...
.response-msg { color: #fff; margin-bottom: 15px; display: block; border-left: 2px solid #333; padding-left: 10px; }
.command-echo { color: $text-command; margin-top: 10px; font-weight: bold; }
...
<body>
    ...
    <div id="main-gui">
        ...
        <div id="input-line">
            ...
            <input type="text" id="cmd-input" autocomplete="off" spellcheck="false" placeholder="Type 'help' for commands...">
        </div>
...
def main():
    print("--- INSTALLING TERMINAL V4.0 (SCROLL FIXED + KNOWLEDGE EXPANDED) ---")
